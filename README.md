...
This project provides powerful **data visualization**, **preprocessing**, and **machine learning** capabilities through an intuitive graphical user interface.

## Features

- **Data Loading**: Supports CSV and ARFF file formats.
...
2. Load a dataset in CSV or ARFF format.
...
Requirements
------------
Ensure you have **Python 3.7+** installed. All dependencies required for this project are listed in the `requirements.txt` file.
